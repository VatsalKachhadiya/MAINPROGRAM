...
<h2 style="margin-left: 10px;">Login Form For Admin</h2>

<form class="login" action="validation_admin.php" method="post">
	...
	<div class="container5" style="background-color:#f1f1f1">
	    ...
	    <button type="button" class="cancelbtn"><a href="/MAINPROGRAM/LOGIN/LOGIN%20AS%20ADMIN/login_admin.php" style="text-decoration: none; color: white;">Cancel</a></button>
