...
<div class="card" style="margin-bottom: 40px;">
  ...
  <img src=" <?php echo "/MAINPROGRAM/HOMEPAGE/authors/".$product['a_img'];  ?> " alt="Avatar" style="width: 200px; height: 200px;" ><br>

	<p style="margin: 1px; padding: 1px; font-size: 18px"> <?php echo strtoupper($product['a_name']);  ?>   </p><br>

  <a style="text-decoration: none; color: white;" href="authordetail_customer.php?id=<?php echo $product['a_id']; ?>" ><button>DETAILS</button></a>
</div>
